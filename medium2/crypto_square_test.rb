...
What is a relation?
Relations are collections of related values, or rows. Each row consists of values that conform to constraints such as TYPE, CHECK constraints, etc. that determine the allowable values for the column that that value is in.